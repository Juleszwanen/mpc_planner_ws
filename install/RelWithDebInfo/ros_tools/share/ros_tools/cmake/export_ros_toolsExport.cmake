...
foreach(_expectedTarget ros_tools::ros_tools)
...
# Create imported target ros_tools::ros_tools
add_library(ros_tools::ros_tools SHARED IMPORTED)
...
file(GLOB CONFIG_FILES "${_DIR}/export_ros_toolsExport-*.cmake")
